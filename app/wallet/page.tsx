...
export default function WalletPage() {
  ...
  return <main className="hoj-proceeds-page">
    ...
    <p className="hoj-proceeds-note">The current live contracts credit the seller with the sale price minus the 2% House fee and any creator royalty; the seller then withdraws those proceeds. The House fee is credited only to the House treasury wallet. This page can withdraw credited balances and refundable offers, but cannot recover arbitrary or uncredited funds stuck in a deployed contract. Network gas is paid separately.</p>
  </main>;
}
