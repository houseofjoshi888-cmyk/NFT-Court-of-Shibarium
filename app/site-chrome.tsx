...
export function GlobalHeader() {
  ...
  return <>
    <aside className="court-sidebar">
      <Link href="/" className="court-brand"><Image className="court-brand-logo" src="/house-of-joshi.png" alt="House of Joshi NFT Marketplace" width={48} height={48} priority/><span><strong>HOUSE OF JOSHI</strong><small>NFT MARKETPLACE</small></span></Link>
    ...
    <header className="court-topbar">
      <Link href="/" className="court-topbar-brand"><Image className="court-topbar-logo" src="/house-of-joshi.png" alt="" width={34} height={34}/><span><strong>HOUSE OF JOSHI</strong><small>NFT MARKETPLACE</small></span></Link>
...
export function GlobalFooter() {
  return <footer className="court-footer">
    <div className="court-footer-main">
      <section className="court-footer-brand"><Link href="/"><Image className="court-footer-logo" src="/house-of-joshi.png" alt="" width={38} height={38}/><span><strong>HOUSE OF JOSHI</strong><small>NFT MARKETPLACE</small></span></Link><p>The premier multichain NFT marketplace, built for collectors and creators.</p></section>
