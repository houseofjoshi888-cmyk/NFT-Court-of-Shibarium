...
export function GlobalHeader() {
  ...
  return <>
    <aside className="court-sidebar">
      ...
      <div className="court-pass"><small>MARKETPLACE ACCESS</small><strong>Multichain · Open</strong><p>Trade on Base, Cronos, Shibarium, and Zora. More networks are coming soon.</p><a href="https://www.nftlaunchpad.thehouseofjoshi.com/" target="_blank" rel="noopener noreferrer">Create NFTs</a></div>
    </aside>
