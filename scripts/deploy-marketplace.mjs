...
const sourceFiles = ["NFTMarketplace.sol", "NFTMarketplaceV4.sol", "NFTMarketplaceV5.sol"];
...
const artifact = output.contracts["contracts/NFTMarketplaceV5.sol"].HOJNFTMarketplace;
if (process.env.COMPILE_ONLY === "1") {
  console.log(`HOJNFTMarketplace compiled for ${chain.name}.`);
  process.exit(0);
}
